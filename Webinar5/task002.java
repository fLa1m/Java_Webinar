...
повторяющиеся буквы одного слова меняются на одну и ту же 
букву с сохранением порядка следования. (Например, add - egg изоморфны)
...
public class task002 {
    public static void main(String[] args) {
        System.out.println(isomorf("foo", "bar"));
    }

    static boolean isomorf(String s1, String s2) {
